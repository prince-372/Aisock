    ...
    <>
      <section className=" bg-commangradiunt relative md:py-16 py-10">
        ...
        <div className=" container px-3 mx-auto">
          ...
          <p className=" font-Opensans font-light sm:text-5xl text-3xl sm:leading-[60px] leading-[31px] text-white text-center pt-2">
            How AI Stocks Workes
          </p>
          <p className=" font-Opensans font-normal text-base text-lightgray1 max-w-[891px] text-center mx-auto pt-6">
          ...
          <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 max-w-[927px] mx-auto sm:pt-24">
